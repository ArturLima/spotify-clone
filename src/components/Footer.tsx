...
export function Footer(){
  return (
    ...
    <div className="flex items-center gap-3">
      <Image src="/eminem.jpg" width={56} height={56} alt="Capa Eminem" />
      <div className="flex flex-col">
        <strong className="font-normal"> Not afraid </strong>
    ...
    <div className="flex flex-col items-center gap-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="h-1 rounded-full w-96 bg-zinc-600">
          <div className="bg-zinc-200 w-40 h-1 rounded-ful"> </div>
        </div>
    ...
    <div className="flex items-center gap-2">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="h-1 rounded-full w-24 bg-zinc-600">
          <div className="bg-zinc-200 w-10 h-1 rounded-ful"> </div>
        </div>
      </div>
      <Maximize2 size={20}/>
    </div>
